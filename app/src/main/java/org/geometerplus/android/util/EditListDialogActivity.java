...
public abstract class EditListDialogActivity extends ListActivity {
	...
	protected void showItemRemoveDialog(final int index) {
		...
		new AlertDialog.Builder(EditListDialogActivity.this)
			...
			.setPositiveButton(buttonResource.getResource("yes").getValue(), new OnClickListener() {
	...
	protected void showItemContextMenuDialog(final int position){
		new AlertDialog.Builder(EditListDialogActivity.this)
			...
			.setItems(myContextMenuItems.toArray(new String[myContextMenuItems.size()]), new OnClickListener() {
	...
	protected class EditListAdapter extends BaseAdapter implements AdapterView.OnItemClickListener,OnItemLongClickListener {
		@Override
		public int getCount() {
